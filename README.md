...
**[Download the Windows preview](https://github.com/Brusko25/Glance-Platform-Releases/releases/tag/v0.2.7)** · [User guide](USER_GUIDE.md) · [Release notes](CHANGELOG.md)
...
1. Download Glance-Platform-0.2.7-Windows.zip from the release page.
...
| Tile | Based on |
| --- | --- |
| Finance | Glance Finance 2.6.5 |
| LLM Usage | Glance LLM Usage 2.2.0 |
| Plex | Glance Plex 2.2.3 |
| Clock and Notes | SDK examples |

All three converted tile packages are version 0.2.7. The release includes their .glancetile files, a creator kit in the Windows ZIP, and SHA-256 checksums.
...
The images below show synthetic test data from version 0.2.7.

![Glance Platform manager](images/v0.2.7/manager.png)

![Finance tile](images/v0.2.7/finance.png)
![Usage tile](images/v0.2.7/usage.png)
![Plex tile](images/v0.2.7/plex.png)