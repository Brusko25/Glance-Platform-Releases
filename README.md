...
**[Download the Windows preview](https://github.com/Brusko25/Glance-Platform-Releases/releases/tag/v0.2.6)** · [User guide](USER_GUIDE.md) · [Release notes](CHANGELOG.md)
...
1. Download Glance-Platform-0.2.6-Windows.zip from the release page.
...
All three converted tile packages are version 0.2.6. The release includes their .glancetile files, a creator kit in the Windows ZIP, and SHA-256 checksums.
...
The images below show synthetic test data from version 0.2.6.

![Glance Platform manager](images/v0.2.6/manager.png)

![Finance tile](images/v0.2.6/finance.png)
![Usage tile](images/v0.2.6/usage.png)
![Plex tile](images/v0.2.6/plex.png)