...
**[Download the Windows preview](https://github.com/Brusko25/Glance-Platform-Releases/releases/tag/v0.2.3)** · [User guide](USER_GUIDE.md) · [Release notes](CHANGELOG.md)
...
1. Download Glance-Platform-0.2.3-Windows.zip from the release page.
...
| Plex | Glance Plex 2.2.2 |
| Clock and Notes | SDK examples |

All three converted tile packages are version 0.2.3. The release includes their .glancetile files, a creator kit in the Windows ZIP, and SHA-256 checksums.
...
The images below show synthetic test data from version 0.2.3.

![Glance Platform manager](images/v0.2.3/manager.png)

![Finance tile](images/v0.2.3/finance.png)
![Usage tile](images/v0.2.3/usage.png)
![Plex tile](images/v0.2.3/plex.png)